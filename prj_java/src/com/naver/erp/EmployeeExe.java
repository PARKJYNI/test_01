...
// (참고) System.out.println("직원명 : " + employee. emp_name);  클래스 Employee 속, 변수 emp_name이  private으로 돼있어서 객체화 한 후 호출 못함. 오직 동료들만 가능. <에러>아 존재는 하는데 안 보여ㅋㅋ (public 으로 변경하면 호출 가능)
